...
libraryDependencies ++= Seq(
  ...
  "com.lihaoyi" %% "mainargs" % "0.7.5" % Test,
  "com.lihaoyi" %% "os-lib" % "0.11.1" % Test,
  "com.lihaoyi" %% "pprint" % "0.9.0" % Test,
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-core" % "2.30.15" % Test,
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "2.30.15" % Test,
