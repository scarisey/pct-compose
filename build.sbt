...
libraryDependencies ++= Seq(
  ...
  "io.github.iltotore" %% "iron-jsoniter" % "3.3.2",
...
libraryDependencies ++= Seq(
  ...
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-core" % "2.40.1" % Test,
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "2.40.1" % Test,
  "io.github.iltotore" %% "iron" % "3.3.2" % Test,
  "io.github.iltotore" %% "iron-scalacheck" % "3.3.2" % Test,
  "io.github.iltotore" %% "iron-jsoniter" % "3.3.2" % Test,
