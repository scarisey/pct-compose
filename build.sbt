...
libraryDependencies ++= Seq(
  ...
  "io.github.iltotore" %% "iron-jsoniter" % "3.0.1",
...
libraryDependencies ++= Seq(
  ...
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-core" % "2.36.4" % Test,
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "2.36.4" % Test,
  "io.github.iltotore" %% "iron" % "3.0.1" % Test,
  "io.github.iltotore" %% "iron-scalacheck" % "3.0.1" % Test,
  "io.github.iltotore" %% "iron-jsoniter" % "3.0.1" % Test,
